...
export default {
  ...
  methods: {
    setThumbsSwiper() {
      this.$refs.zSwiper.swiper.on("beforeMount", () => {
        this.$refs.zSwiper.swiper.params.thumbs.swiper =
          this.$refs.zSwiperThumbs.swiper;
      });
    },
    setThumbsAutoSwiper() {
      this.$refs.zSwiperAuto.swiper.on("beforeMount", () => {
        this.$refs.zSwiperAuto.swiper.params.thumbs.swiper =
          this.$refs.zSwiperThumbsAuto.swiper;
      });
    },
  },
};
