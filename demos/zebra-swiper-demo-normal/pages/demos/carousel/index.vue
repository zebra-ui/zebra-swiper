			...
			<z-swiper-item v-for="(item,index) in list" :key="index" :custom-style="{width:'500rpx'}">
				<div class="carousel-slider-animate-opacity">
					...
					<div class="slide-content">
						<view class="slide-content-title">Guardians Of The Galaxy</view>
						<view class="slide-content-detail">A group of intergalactic criminals must pull together to stop
							a fanatical warrior with
							plans
							to purge
							the universe.</view>
					</div>
