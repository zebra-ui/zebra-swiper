...
const setThumbsSwiperInverse = () => {
  zswiperinverse.value.swiper.on('beforeMount', (swiper) => {
    zswiperinverse.value.swiper.params.controller.control =
      zswiperthumbsinverse.value.swiper
  })

  zswiperthumbsinverse.value.swiper.on('beforeMount', (swiper) => {
    zswiperthumbsinverse.value.swiper.params.controller.control =
      zswiperinverse.value.swiper
  })
}
</script>
