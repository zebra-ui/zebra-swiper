<template>
	<view class="demo-swiper">
		...
		<demo-block title="无限循环">
			<z-swiper v-model:list="loopList" loop virtual :modules="modules" :virtualList="virtualListLoop">
				<z-swiper-item v-for="(item,index) in loopList" :key="index" :virtualIndex="item.virtualIndex"
					:custom-style="item.props.style">
					<demo-item :item="item"></demo-item>
				</z-swiper-item>
			</z-swiper>
